...
#Data Processing
#total_declaration_area_df = read.csv(('/Users/angelwang/Desktop/fall 2023/4243/ADS-Fall2023-Project2-ShinyApp-Group-8/data/FemaWebDeclarationAreas.csv'))

total_citi_bike_df = read.csv('/Users/angelwang/Desktop/fall 2023/4243/ADS-Fall2023-Project2-ShinyApp-Group-8/data/citibike_data.csv')
...
#total_declaration_area_state <- total_declaration_area_df[, c('stateCode', 'stateName',	'placeCode',	'placeName')]
